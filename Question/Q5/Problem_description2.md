HankerRank problem description : 

    We use the integers , , and  to create the following series:

    (a+2^0.b),(a+2^0.b+2^1.b),....,(a+2^0.b+....+2^n-1.b)

    You are given q queries in the form of a, b, and n. For each query, print the series corresponding to the given a, b,n and  values as a single line of n space-separated integers.
...
Explanation : 
    ...
    2. We use a=5, b=3, and n=5 to produce some series s0, s1, s2 ,...., sn-1:
        ...
        s1 = 5 + 1 . 3 + 2 . 3;
        s2 = 5 + 1 . 3 + 2 . 3 + 4 . 3;
        s3 = 5 + 1 . 3 + 2 . 3 + 4 . 3 + 8 . 3; 
        s4 = 5 + 1 . 3 + 2 . 3 + 4 . 3 + 8 . 3 + 16 . 3; 
